...
class MainContract(models.Model):
    ...
    def calculate_total_contract_resource_variance_to_date_calculation(self):
        ...
        for detail in self.details.all():  
            ...
            total_variance_to_date_cost += resource_usage_data.get('total_cost_difference', 0)
    ...
    def calculate_total_contract_ETC_remaining_calculation(self):
        ...
        for detail in self.details.all():  
            ...
            total_ETC_cost += resource_usage_data.get('total_cost_difference', 0)
    ...
    def calculate_total_contract_VAC_remaining_calculation(self):
        ...
        for detail in self.details.all():  
            ...
            total_VAC_cost += resource_usage_data.get('total_cost_difference', 0)
    ...
    def contract_assemblies_level_2_values(self, assemblies_level_1_record):
        from assembliesApp.models import Assemblies_Code_L2_Table
        filter_assembly_level_2 = Assemblies_Code_L2_Table.objects.filter(Assemblies_Code_L1=assemblies_level_1_record, Company_Details=self.company_details)
        resource_usage = {}
    ...
    def contract_assemblies_level_3_values(self, assemblies_level_1_record, assemblies_level_2_record):
        ...
        print(assemblies_level_1_record, assemblies_level_2_record)
        filter_assembly_level_3 = Assemblies_Code_L3_Table.objects.filter(Assemblies_Code_L1=assemblies_level_1_record, Assemblies_Code_L2=assemblies_level_2_record, Company_Details=self.company_details)
        print('filter_assembly_level_3')
        print(filter_assembly_level_3)
        resource_usage = {}
        ...
        for assemblies_level_3_record in filter_assembly_level_3:
            ...
            resource_usage[assemblies_level_3_record.Assemblies_Code_L3] = {
                ...
                "estimate_at_completion_eac": Estimate_At_Completion_EAC,
                "vac_value": VAC_value,
                "resource_level_3_values": self.contract_resource_level_1_values(assemblies_level_1_record, assemblies_level_2_record, assemblies_level_3_record)
            }
    ...
    def contract_resource_level_1_values(self, assemblies_level_1_record, assemblies_level_2_record, assemblies_level_3_record):
        ...
        # from .models import SubContractInvoiceDetailsTable
        # from maincontractApp.models import MainContractInvoiceDetailsTable
        ...
        for resource_level_1_record in filter_resource_level_1:
            Assembly_Level_3_Name = resource_level_1_record.Resource_Code_L1
            Unit = ''
            total_unit_cost = 0
            Contract_Quantity = 0
            Budget_Quantity = 0
            ...
            filter_Estimation_Assemblies_Resource_Details = Estimation_Assemblies_Resource_Details_Table.objects.filter(
                ...
                Estimation_Assemblies__in=filter_Estimation_Assemblies, 
                Resource_record__Resource_Code_L1 = resource_level_1_record
            )
            ...
            if filter_Estimation_Assemblies_Resource_Details:
                total_unit_cost = round(filter_Estimation_Assemblies_Resource_Details.aggregate(total=Sum('Resource_Budget_Unit_Cost'))['total'], 2)
                Contract_Quantity = ""
                Budget_Quantity = ""
                Total_Budget_Costs = ""
                Total_Markup_Amount = ""
                Unit_Price = round(filter_Estimation_Assemblies_Resource_Details.aggregate(total=Sum('Unit_Cost'))['total'], 2)
                Total_Price = ""
                Total_Target_Profit = ""
            
            for detail in filter_Estimation_Assemblies_Resource_Details:  
                resource_cost_data = detail.actual_cost_total_resource_code_calculation()
                Total_Actual_Resources_Cost += resource_cost_data.get('total_sum_assembly_resource_code_amount_var', 0)
                Total_Actual_Resources_Cost = round(Total_Actual_Resources_Cost, 2)
...
class MainContractDetail(models.Model):
    ...
    def contract_resource_budget_cost_calculation(self):
        ...
        for resoures_level_1_record in filter_resoures_level_1:
            ...
            resource_budget_cost = resourse_unit_cost * float(contract_quantity)
    ...
    def contract_resource_variance_to_date_calculation(self):
        ...
        cost_difference['total_cost_difference'] = round(total_budget_cost - total_subcontract_cost, 2)
    ...
    def contract_ETC_remaining_calculation(self):
        ...
        total_subcontract_cost = subcontract_costs.get('total_sum_calculate_usage_amount', 0)
        cost_difference['total_cost_difference'] = round(total_estimate_at_completion_cost - total_subcontract_cost, 2)
        return cost_difference
    ...
    def contract_VAC_remaining_calculation(self):
        ...
        cost_difference['total_cost_difference'] = round(total_budget_cost - total_get_EAC_cost, 2)
        return cost_difference
